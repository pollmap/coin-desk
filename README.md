...
현재 릴리스: **0.12.0**. 코인 검색 선택기, 페이지 간 KRW/USDT 가격 기준 유지, 가로 지표 목록과 웃는 시바견 브랜드를 적용했습니다. 사용자 제공 X 계정 37개의 원문·차트·영상 탐색을 추가했습니다. X 자동 수집기는 인증 미연결 상태로 구분합니다. [변경·검증 기록](docs/UPGRADE12.md) · [리서치 화면](https://coin-desk.pages.dev/research).
