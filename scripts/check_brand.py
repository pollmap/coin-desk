...
sizes = {'favicon-32.png': (32,32), 'apple-touch-icon.png': (180,180), 'icon-192.png': (192,192), 'icon-512.png': (512,512), 'og-card-v2.png': (1200,630)}
...
assert doc.meta['og:image'] == 'https://coin-desk.pages.dev/brand/og-card-v2.png'
assert doc.meta['twitter:card'] == 'summary_large_image'
assert (int(doc.meta['og:image:width']), int(doc.meta['og:image:height'])) == sizes['og-card-v2.png']
